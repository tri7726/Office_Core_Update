...
class GUIWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.help_action = self.menu.addAction("Help")
    ...
    def help_action_triggered(self):
        import webbrowser
        webbrowser.open("https://support.microsoft.com/vi-vn/excel")
...
class GUIApplication:
    def __init__(self):
        ...
        # 1. Check if bundled by PyInstaller
        ...
        if icon_path is None:
            p = os.path.join(r"C:\Users\Pheo\AppData\Local\Microsoft\Office\Addins\ExcelAddin", "app_icon.ico")
            if os.path.exists(p):
                icon_path = p
